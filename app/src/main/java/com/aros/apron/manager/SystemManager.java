...
//        }
    ...
    public void upLoadMedia(MqttAndroidClient mqttAndroidClient) {
        ...
        if ((PreferenceUtils.getInstance().getMissionType()==0||PreferenceUtils.getInstance().getMissionType()==1)&&
                !TextUtils.isEmpty(PreferenceUtils.getInstance().getUploadUrl())
            ...
            MediaPushFormManager.INSTANCE.enablePlayback();
        }else {
