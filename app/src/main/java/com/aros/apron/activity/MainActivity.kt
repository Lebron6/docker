...
open class MainActivity : BaseActivity() {
    ...
    private fun updateFPVWidgetSource(availableCameraList: List<ComponentIndexType>?) {
        ...
        //大于两路数据
        val primarySource: ComponentIndexType =
            getSuitableSource(cameraList, ComponentIndexType.LEFT_OR_MAIN)
        primaryFpvWidget!!.updateVideoSource(primarySource)
        cameraList.remove(primarySource)
        val secondarySource: ComponentIndexType =
            getSuitableSource(cameraList, ComponentIndexType.FPV)
